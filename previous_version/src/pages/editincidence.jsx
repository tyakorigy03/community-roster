              ...
              <div className="border-2 border-dashed border-slate-300 p-6 hover:border-blue-400 transition-colors">
                ...
                <div className="space-y-3">
                  ...
                  {existingAttachments.length > 0 && (
                    <div className="mb-4">
                      <p className="text-sm font-medium text-slate-700 mb-2">Existing Attachments:</p>
                      ...
                      <div className="flex justify-between items-center mb-4">
                        <div>
                          <p className="text-sm font-medium text-slate-700">
                            {attachments.length} new file{attachments.length !== 1 ? 's' : ''} to upload
                          </p>
                          <p className="text-xs text-slate-500">
                ...
                <div className="bg-white p-4 border border-amber-200">
                  <div className="flex flex-col">
                    ...
                    <p className="text-xs text-slate-500 mt-2 flex items-start gap-1">
                      ...
                      As an admin, you can edit progress notes on behalf of other staff members.
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div className="flex flex-col sm:flex-row justify-between items-center gap-4">
                ...
                <div className="flex gap-3">
                  <button
                    ...
                    className="px-6 py-3 border border-slate-300 hover:bg-slate-50 text-slate-700 font-medium transition disabled:opacity-50 disabled:cursor-not-allowed"
                    disabled={isSubmitting}
                  >
                    Cancel
                  </button>
