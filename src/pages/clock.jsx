  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-blue-50 to-gray-100 p-4">
      <div className="max-w-md mx-auto">
        ...
        {/* Current Status */}
        {currentStatus && (
          <div className={`rounded-xl border p-4 mb-6 ${currentStatus === 'clocked_in'
              ? 'bg-yellow-50 border-yellow-200'
              : 'bg-green-50 border-green-200'
            }`}>
            <div className="flex items-center gap-3">
              <div className={`p-2 rounded-lg ${currentStatus === 'clocked_in' ? 'bg-yellow-100' : 'bg-green-100'
                }`}>
        ...
        <div className="sticky bottom-6">
          {currentStatus === 'clocked_in' ? (
            <button
              ...
              className={`w-full py-4 text-lg font-semibold rounded-xl shadow-lg transition-all ${submitting || uploadingPhoto || (requiresPhoto && !photoPublicUrl)
